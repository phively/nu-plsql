...
adv_dates As (
  ...
  Union All Select '0000235591', 'AF', to_date('20160501', 'yyyymmdd'), NULL From DUAL
  ...
  Union All Select '0000220843', 'MG', to_date('20161101', 'yyyymmdd'), NULL From DUAL
  Union All Select '0000482601', 'AF', to_date('20120101', 'yyyymmdd'), NULL From DUAL
  Union All Select '0000532713', 'MG', to_date('20120201', 'yyyymmdd'), to_date('20140701', 'yyyymmdd') From DUAL
  Union All Select '0000740856', 'AF', to_date('20171001', 'yyyymmdd'), NULL From DUAL
  Union All Select '0000737745', 'MG', to_date('20151101', 'yyyymmdd'), to_date('20170401', 'yyyymmdd') From DUAL
  Union All Select '0000642888', 'MG', to_date('20160901', 'yyyymmdd'), NULL From DUAL
  Union All Select '0000784241', 'AF', to_date('20170901', 'yyyymmdd'), NULL From DUAL
  Union All Select '0000779347', 'MG', to_date('20170701', 'yyyymmdd'), NULL From DUAL
  ...
  Union All Select '0000765494', 'AF', to_date('20161001', 'yyyymmdd'), NULL From DUAL
  Union All Select '0000541522', 'MG', to_date('20061101', 'yyyymmdd'), to_date('20130101', 'yyyymmdd') From DUAL
  Union All Select '0000776709', 'MG', to_date('20170401', 'yyyymmdd'), NULL From DUAL
  Union All Select '0000561243', 'MG', to_date('20110701', 'yyyymmdd'), NULL From DUAL
  Union All Select '0000732336', 'AF', to_date('20171101', 'yyyymmdd'), NULL From DUAL
  Union All Select '0000549376', 'MG', to_date('20070801', 'yyyymmdd'), NULL From DUAL
  Union All Select '0000772028', 'MG', to_date('20170201', 'yyyymmdd'), NULL From DUAL
  Union All Select '0000716237', 'MG', to_date('20150201', 'yyyymmdd'), to_date('20160801', 'yyyymmdd') From DUAL
  Union All Select '0000565742', 'MG', to_date('20080901', 'yyyymmdd'), NULL From DUAL
  Union All Select '0000562459', 'MG', to_date('20080801', 'yyyymmdd'), NULL From DUAL
  ...
  Union All Select '0000780506', 'AF', to_date('20180101', 'yyyymmdd'), NULL From DUAL
  Union All Select '0000783777', 'AF', to_date('20171001', 'yyyymmdd'), NULL From DUAL
)
