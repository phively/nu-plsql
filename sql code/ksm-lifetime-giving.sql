...
ksm_trans As (
  (
    ...
    -- Matching gift
    Select match_gift_matched_donor_id, match_gift_receipt_number, match_gift_matched_sequence, 'Matching Gift', match_gift_date_of_record, match_gift_amount
...
Where entity.id_number = '0000598677'
