  ...
  , Case
      ...
      When degree_level_rank = '02 MBA'
        Then Case
          ...
          When department_desc_short Like '%Kellogg LAP%' Then 'EMP-FL'
          When department_desc_short Like '%Kellogg HK%' Then 'EMP-HK'
          When department_desc_short Like '%Kellogg JNA%' Then 'EMP-JAN'
          When department_desc_short Like '%Kellogg RU%' Then 'EMP-ISR'
          When department_desc_short Like '%Kellogg PKU%' Then 'EMP-CHI'
