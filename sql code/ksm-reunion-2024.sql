...
SELECT DISTINCT 
  ...
  ,CASE WHEN ksm24.ID_NUMBER IS NOT NULL THEN 'Y' END AS REGISTERED_REUNION_2024
  ...
  ,FINAL.FOUNDATION_DATE_GIFT_CYD_CFY AS FOUNDATION_DATE_GIFT_CYD_FY24
  ...
  ,FINAL.FOUNDATION_DATE_GIFT_CYD_PFY AS FOUNDATION_DATE_GIFT_CYD_FY23
