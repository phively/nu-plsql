...
--- KSM 2024 Registrants

---ksm24 as (select *
---from ksm_reunion_24_regs)

--- 2024 Event is now in! 
...
where EP_REGISTRATION.EVENT_ID = '30185')
...
SELECT DISTINCT 
  ...
  ,case when R24P.id_number is not null then 'Y' end as Participated_2024_Reunion
  ,case when R24R.CONTACT_ID_NUMBER is not null then 'Y' end as Registered_2024_Reunion
...
--- KSM 2024 Registrants
LEFT JOIN REUNION_2024_PARTICIPANTS R24P
ON R24P.ID_NUMBER = E.ID_NUMBER
LEFT JOIN REUNION_2024_REGISTRANTS  R24R
ON R24R.CONTACT_ID_NUMBER = E.ID_NUMBER 
---LEFT JOIN ksm24
---ON ksm24.ID_NUMBER = E.ID_NUMBER
