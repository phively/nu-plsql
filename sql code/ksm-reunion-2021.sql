...
SELECT DISTINCT
  ...
  ,CASE WHEN RC15.ID_NUMBER IS NOT NULL THEN 'Y' END AS "REUNION_2015_COMMITTEE"
  ,CASE WHEN RC16.ID_NUMBER IS NOT NULL THEN 'Y' END AS "REUNION_2016_COMMITTEE"
  ,CASE WHEN RC20.ID_NUMBER IS NOT NULL THEN 'Y' END AS "REUNION_2020_COMMITTEE"
  ,CASE WHEN RC21.ID_NUMBER IS NOT NULL THEN 'Y' END AS "REUNION_2021_COMMITTEE"
  ,CASE WHEN PRC.ID_NUMBER IS NOT NULL THEN 'Y' END AS "PAST_REUNION_COMMITEE"
  ...
  ,KSMT.KSM_TOTAL
  ,KAFT.KSM_AF_TOTAL
  ,KSM19.KSM_TOTAL AS KSM_TOTAL_2019
  ,CASE WHEN KM19.ID_NUMBER IS NOT NULL THEN 'Y' END AS MATCH_2019
  ,NP.OFFICER_RATING
...
LEFT JOIN REUNION_16_COMMITTEE RC20
...
LEFT JOIN REUNION_2020_PARTICIPANTS R20
...
LEFT JOIN KSM_TOTAL19 KSM19
  ON E.ID_NUMBER = KSM19.ID_NUMBER
LEFT JOIN KSM_MATCH_19 KM19
  ON E.ID_NUMBER = KM19.ID_NUMBER
LEFT JOIN NU_PRS_TRP_PROSPECT NP
  ON E.ID_NUMBER = NP.ID_NUMBER
