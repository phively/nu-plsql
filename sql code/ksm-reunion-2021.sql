...
WHERE TO_NUMBER(NVL(TRIM(A.CLASS_YEAR),'1')) IN (MD.CFY-4, MD.CFY-9, MD.CFY-14, MD.CFY-19, MD.CFY-24, MD.CFY-29, MD.CFY-34, MD.CFY-39,
...
--- Reunion 2016 Committee Instead
...
SELECT DISTINCT
  ...
  ,CASE WHEN R16.ID_NUMBER IS NOT NULL THEN 'Y' END AS "REUNION_2016_COMMITTEE"
  ...
  ,CASE WHEN WT0_PKG.IsCurrentTrustee(E.ID_NUMBER) = 'TRUE' THEN 'Trustee'
     WHEN WT0_PKG.IsCurrentTrustee(E.SPOUSE_ID_NUMBER) = 'TRUE' THEN 'Spouse Trustee' ELSE ' ' END TRUSTEE
       ---- Removed 2015 Reunion and Replaced it with 2016 Reunion
...
LEFT JOIN REUNION_16_COMMITTEE R16
ON E.ID_NUMBER = R16.ID_NUMBER
...
LEFT JOIN REUNION_2015_PARTICIPANTS RP
ON E.ID_NUMBER = RP.ID_NUMBER
