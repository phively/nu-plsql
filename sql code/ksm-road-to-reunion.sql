/* Road to Reunion 2021 View
Includes both the 2020 and 2021 Reunion Populations
*/ 

Create or Replace View Road_to_Reunion AS 
...
MD.CFY-52, MD.CFY-53,
MD.CFY-54, MD.CFY-55,
MD.CFY-56, MD.CFY-57, MD.CFY-58, MD.CFY-59,
MD.CFY-60, MD.CFY-61, MD.CFY-62)
AND A.AFFIL_CODE = 'KM'
...
and TMS_EVENT_REGISTRATION_STATUS.short_desc IN ('Registration','Cancelled'))
---- Edit: Add in a where function to include both canceled and reg )
