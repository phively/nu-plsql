...
WHERE TO_NUMBER(NVL(TRIM(A.CLASS_YEAR),'0')) IN (MD.CFY-1, MD.CFY-5, MD.CFY-10, MD.CFY-15, MD.CFY-20, MD.CFY-25, MD.CFY-30, MD.CFY-35, MD.CFY-40,
...
SELECT DISTINCT
  ...
  ,CASE WHEN WT0_PKG.IsCurrentTrustee(E.ID_NUMBER) = 'TRUE' THEN 'Trustee'
     WHEN WT0_PKG.IsCurrentTrustee(E.SPOUSE_ID_NUMBER) = 'TRUE' THEN 'Spouse Trustee' ELSE ' ' END TRUSTEE
       ---- 2015 + 2016 Reunion Participants
...
LEFT JOIN REUNION_15_COMMITTEE R15
ON E.ID_NUMBER = R15.ID_NUMBER
