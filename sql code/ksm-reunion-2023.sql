...
,REUNION_23_REGISTRANTS AS (
select ksm_reunion_23_regs.id_number
from ksm_reunion_23_regs)
...
SELECT DISTINCT
  ...
  ,CASE WHEN RE23.ID_NUMBER IS NOT NULL THEN 'Y' END AS "REGISTERED_2023_REUNION"
