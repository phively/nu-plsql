...
--- Edit 2/14/23: Request to add a flag to Current Reunion Registrants
,REUNION_23_REGISTRANTS AS (select EP_REGISTRATION.CONTACT_ID_NUMBER,
...
where EP_REGISTRATION.EVENT_ID = '28145')

,REUNION_23_PARTICIPANTS AS (Select ep_participant.id_number,
ep_event.event_id
From ep_event
...
SELECT DISTINCT
  ...
  ,CASE WHEN RE23.CONTACT_ID_NUMBER IS NOT NULL THEN 'Y' END AS "REGISTERED_2023_REUNION"
  ,CASE WHEN PRE23.ID_NUMBER IS NOT NULL THEN 'Y' END AS "ATTENDED_2023_REUNION"
...
LEFT JOIN REUNION_23_REGISTRANTS RE23
ON RE23.CONTACT_ID_NUMBER = E.ID_NUMBER
LEFT JOIN REUNION_23_PARTICIPANTS PRE23
ON PRE23.ID_NUMBER = E.ID_NUMBER;
