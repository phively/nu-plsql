Drop Table tbl_IR_FY22_custom_name --<UPDATE THIS>
;

Create Table tbl_IR_FY22_custom_name ( --<UPDATE THIS>
...
Insert All --<UPDATE THIS> all years need fixing, but this should really be copy-pasted from the proofing sheet
  ...
  Into tbl_IR_FY22_custom_name Values('1234567890', 'Example Guy ''09 and Nonalum<LOYAL>', 'Y')
  -- main SQL script will still append <LOYAL> and <KLC> if applicable
  Into tbl_IR_FY22_custom_name Values('1234567891', 'Example Gal ''09 and Nonalum', '')
  -- be sure to include any <DECEASED> tags
  Into tbl_IR_FY22_custom_name Values('1234567892', 'Surviving Alum ''60 and Passed Away ''45<DECEASED>', '')
-- Commit table
Select * From DUAL
;
Commit Work
...
Select
  ...
  , Case
      ...
      End
    As check_by_hand
From tbl_IR_FY22_custom_name cust_name --<UPDATE THIS>
Inner Join entity
