...
Select
  ...
  , corpgov_status
  , corpgov_role
  , corpgov_committee_title
  , divsummit_ind
  , ds_start_date
  , ds_stop_date
  , ds_status
  , ds_role
  , divsummit_committee_title
  , realest_ind
  , rec_start_date
  , rec_stop_date
  , rec_status
  ...
  , amp_committee_title
  , healthcare_ind
  , healthcare_start_date
  , healthcare_stop_date
  , healthcare_status
  , healthcare_role
  , healthcare_committee_title
  , womensleadership_ind
  , womensleadership_start_date
  , womensleadership_stop_date
  , womensleadership_status
  , womensleadership_role
  , womens_committee_title
  , kac_ind
  , kac_start_date
  , kac_stop_date
  , kac_status
  ...
  , inclusion_status
  , inclusion_role
  , inclusion_committee_title
  , private_equity_ind
  , private_equity_start_date
  , private_equity_stop_date
