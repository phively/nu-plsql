...
/* Requires the gift data aggregated in v_af_gifts_srcdnr_5fy. Aggregated by household giving source donor and related fields,
...
Select
  -- Entity fields
  id_hh_src_dnr, pref_name_sort, report_name, person_or_org, record_status_code, institutional_suffix,
